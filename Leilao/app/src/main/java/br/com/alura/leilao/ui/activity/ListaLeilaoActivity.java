...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    private List<Leilao> leiloesDeExemplo() {
        ...
        console.propoe(new Lance(new Usuario("Leandro"), 300.0));

        Leilao computador = new Leilao("Computador");
        computador.propoe(new Lance(new Usuario("Alex"), 1000.0));

        Leilao carro = new Leilao("Carro");
        carro.propoe(new Lance(new Usuario("Alex"), 17000.0));
        carro.propoe(new Lance(new Usuario("Leandro"), 19000.0));
        carro.propoe(new Lance(new Usuario("João"), 2000.0));
